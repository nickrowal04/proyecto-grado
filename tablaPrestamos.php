...
<script type="text/javascript">
	...
	{
		var respuesta =confirm("Estas seguro que quieres cancelar el préstamo? ");
		if(respuesta==true){
			return true;
		}
		else{
...
<header class="u-clearfix u-gradient u-header u-header" id="sec-a4ee"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <center><h2 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1"> Solicitudes de préstamo  </h2></center>
      </div>
</header>
...
<!--
	...
	Tabla de solicitudes para solicitar los instrumentos 
         en la academia de música el Cubarro de Oro<br>
		<?php
        include "conexion.php";
        $consltas = "SELECT COUNT(id_prestamo) FROM prestamos where proceso='validando petición'";
...
//que guarde todo en la variable centencia y que lo guarde en la variable resultado	  
			include "conexion.php";
			$sql = "SELECT * FROM  prestamos where proceso='validando petición'" ; 			
...
while ($filas=mysqli_fetch_assoc($result) )
			{
					...
					//modificar
echo "<td ><center><br> <a href='validarPrestamoo.php?id_prestamo=".$filas['id_prestamo']."'> <button type='button' class='boton_personalizado_4'>aceptar prestamo del Instrumento</button></a></center> ";
					//eliminar
echo "<center><br> <a href='cancelarPrestamo.php?id_prestamo=".$filas['id_prestamo']."'> <button type='button' class='boton_personalizado_4' onclick='return confirmDelete()'>cancelar prestamo del Instrumento</button></a></td></center> ";
