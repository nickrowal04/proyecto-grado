...
<link rel="icon" type="image/jpg" href="https://i.ibb.co/BTczYFc/logo-Proyecto.png"/>
	...
	<title>Instrumentos registrados  </title>
...
<header class="u-clearfix u-gradient u-header u-header" id="sec-a4ee"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <center><h2 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1"> Instrumentos registrados</h2></center>
      </div>
</header>
...
<!--
	...
	<table border="2%" align="center">
		<thead>
			...
			<a href="formularioingresoInstrumentos.php"style="color:#005423 ;">  -<i class="fa fa-user-plus"></i>Añadir</a>
...
while ($filas=mysqli_fetch_assoc($result) )
			{
				echo "<tr>";
					...
					//modificar
echo "<td ><center><br> <a href='editarInstrumentos.php?instrumentosNombre=".$filas['instrumentosNombre']."'> <button type='button' class='boton_personalizado_4'>Editar</button></a></center> ";
					//eliminar
echo "<center><br> <a href='eliminarInstrumento.php?instrumentosNombre=".$filas['instrumentosNombre']."'> <button type='button' class='boton_personalizado_4' onclick='return confirmDelete()'>Eliminar</button></a></td></center> ";
