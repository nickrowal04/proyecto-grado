...
<link rel="icon" type="image/jpg" href="https://i.ibb.co/BTczYFc/logo-Proyecto.png"/>
	...
	<title>mis solicitudes de préstamo  </title>
...
<header class="u-clearfix u-gradient u-header u-header" id="sec-a4ee"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <center><h2 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1">Mis solicitudes de préstamo</h2></center>
      </div>
</header>
...
<!--
    ...
    <p class="panel-heading">
		...
		include "conexion.php";
			$consltas = "SELECT COUNT(email) FROM prestamos where email='$usuario'";
	...
	<table border="1%" align="center" bordercolor="black">
		<thead>
			...
			<th COLSPAN="2" style="width: 100x;" >Tabla de mis solicitudes de préstamo. 
...
//que guarde todo en la variable centencia y que lo guarde en la variable resultado	  
			include "conexion.php";
			$sql = "SELECT * FROM prestamos where email='$usuario' "; 			
...
while ($filas=mysqli_fetch_assoc($result) )
			{
				echo "<tr>";
                    ...
                    echo "  <B>Fecha de entrega</B> "; echo $filas['fechaValidacion']; echo "<br>";			
					//modificar
