            ...
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  ...
                  <br>
                  <a href="menuPrincipalUsuario.php"style="color:#005423 ;"><i class="fa fa-mail-reply style color:green"></i> Atrás</a>
                  <div class="u-form u-form-1">

        <form action="validacionsugerencia.php" method="post">
        <input type="hidden" name="email" value="<?php  $id = $_SESSION['id']; echo $id  ?>">
          <div class="u-form-group u-form-name u-label-none">
              <label for="name-3b9a" class="u-label">Name</label>
              <textarea placeholder="Escribe tu sugerencia." rows="4" cols="50" id="message-6797" name="sugerencia" class="u-border-1 u-border-grey-90 u-input u-input-rectangle u-radius-15" required=""></textarea></div>
              <input type="hidden" name="respuesta" value="Encontrando solución">
          ...
          <input type="submit" value="Enviar sugerencia" name="btnIngresar"class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-2 u-radius-50 u-btn-1">
          <br>
          </div>
        </form>
                    <!--
