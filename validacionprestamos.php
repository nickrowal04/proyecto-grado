...
$sql = "INSERT INTO prestamos (instrumentosNombre,email,fechaPeticion,proceso) VALUES ('$instrumentosNombre','$email','$fechaPeticion','$proceso');";


if (mysqli_multi_query($con, $sql)) {
//echo "SE AÑADIERON NUEVOS DATOS A LA TABLA";
echo '<script>alert("los datos se enviaron al administrador  :)"); window.location="pedirInstrumento.php"</script>';
} 
else {
