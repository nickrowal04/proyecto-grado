...
<html style="font-size: 16px;" lang="es"><head>
    ...
    <title>Devolución del instrumento</title>
...
<link rel="stylesheet" href="administrador/ModificarDatos.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="es"><header class="u-clearfix u-gradient u-header u-header" id="sec-a4ee"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1"> Devolución del instrumento </h2>
      </div></header>
            ...
            <div class="u-layout-row">
              ...
              <div class="u-container-style u-grey-10 u-layout-cell u-radius-50 u-size-30 u-layout-cell-2">
                <div class="u-border-2 u-border-black u-container-layout u-container-layout-2">
                  <h3 class="u-custom-font u-font-oswald u-text u-text-2">Devolución   </h3>
...
//que guarde todo en la variable centencia y que lo guarde en la variable resultado	  
			...
			?>
                    ...
                    <form action="validaciondevolucion.php" method="post"> 
  			...
  			<input type="hidden" name="email" value="<?php echo $consulta[2] ?>"pattern="[A-Za-z0-9_-]{1,15}"required>
                        ...
                        <tr style="height: 75px;">
                          ...
                          <td class="u-border-1 u-border-white u-table-cell"><input type="Hidden" name="proceso" value="Almacenado en la academia ">
			  <label>Almacenado en la academia </label></td>
                        </tr>
                        <tr style="height: 75px;">
                        <?php $fcha = date("Y-m-d");
                        //echo"$fcha";
                        ...
                        ?>    
                           ...
                           <center> <input type="hidden"  name="fechaValidacion" value="<?php echo $fcha; ?>"required ><center>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <br>
                  <button class="u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-custom-color-2 u-radius-50 u-btn-3"" name="btnIngresar" type="submit">Enviar devolucion </button> </center>    
                <br>
                </form >
                </div>
              </div>
