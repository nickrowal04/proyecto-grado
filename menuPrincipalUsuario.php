...
<link rel="stylesheet" href="administrador/menuPrincipal.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="es"><header class="u-clearfix u-gradient u-header u-header" id="sec-a4ee"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1"> Panel de Estudiantes</h2>
      </div></header>
                ...
                <div class="u-layout-col">
                  <div class="u-container-style u-grey-5 u-layout-cell u-radius-25 u-shape-round u-size-40 u-layout-cell-1">
                    <div class="u-border-2 u-border-black u-container-layout u-container-layout-1">
                      ...
                      <ul class="u-custom-font u-font-oswald u-text u-text-3">
                         <li><a href="editarUsuarios.php"><i class="fa fa-user-circle" aria-hidden="true"></i>Perfil</a></li>			
                      <li><a href="#"><i class="fa fa-home"></i>Inicio Usuario</a></li>
                      <li><a href="sugerenciaFormulario.php"><i class="fa fa-globe"></i>Ingresar sugerencia</a></li>
			                <li><a href="vermissugerencias.php"><i class="fa fa-globe"></i>Ver mis sugerencia</a></li>   
                      <br>
			                    <li><a href="pedirInstrumento.php"><i class="fa fa-address-book"></i> Solicitar instrumento  </a></li>
		                    	<li><a href="tablaInstrumentosUsuarios.php"><i class="icon fa fa-table fa-fw"></i> Tabla de instrumentos</a></li>
		                    	<li><a href="VerMIsPrestamos.php"><i class="fa fa-globe"></i>Ver petisiones</a></li>
