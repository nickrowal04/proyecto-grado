...
<header class="u-clearfix u-gradient u-header u-header" id="sec-a4ee"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1"> Usuarios registrados</h2>
      </div>
</header>
...
<!--
    ...
    <p class="panel-heading">
		Tabla de usuarios registrados en la academia de música el Cubarro de Oro<br>
		<?php
		include "conexion.php";
			$consltas = "SELECT COUNT(email) FROM usuarios";
	...
	<!--<h1 style="color:blue;"><center><legend>INICIO DE ADMINISTRADOR</legend></center></h1>-->
	<br>
	<br>
	<br>
	<br>
	<table border="2%" align="center">
		<thead>
			...
			<th style="width: 100x;">Datos de estudiantes</th>
			<th style="width: 250px;">Fotos</th>
			...
			<th style="width: 1px;">
			<a href="formularioIngreso.php"style="color:#005423 ;"><i class="fa fa-user-plus"></i>Añadir</a>
...
while ($filas=mysqli_fetch_assoc($result) )
			{
				echo "<tr>";
					echo "<td>  Nombre: "; echo $filas['nombre']; echo "<br>";
					echo "  Apellido: "; echo $filas['apellido']; echo "<br>";
					echo "  Identificacion: "; echo $filas['Identificacion']; echo "<br>";
					echo "  Edad: "; echo $filas['edad']; echo "<br>";	
					echo "  Grado: "; echo $filas['grado']; echo "<br>";
					echo "  Email: <br>"; echo $filas['email']; echo "</td>";

					?>
					<td style="height: 170px;"><center><br><img src=" <?php echo $filas['foto'];  ?>" width="120"  alt="" srcset=""  class='imgRedonda'></center></td>       
					<?php
	
					
					//modificar
echo "<td ><center><br> <a href='editarPersonas.php?email=".$filas['email']."'> <button type='button' class='boton_personalizado_4'>Editar</button></a></center> ";
					//eliminar
echo "<center><br> <a href='eliminarpersonas.php?email=".$filas['email']."'> <button type='button' class='boton_personalizado_4' onclick='return confirmDelete()'>Eliminar</button></a></td></center> ";
